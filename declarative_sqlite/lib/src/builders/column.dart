...
abstract class Column {
  ...
  factory Column.parse(String expression) {
    ...
    if (orderByMatch != null) {
      ...
      return Column.parse(columnPart); // Recursively parse the column part
    }
...
class SimpleColumn extends Column {
  ...
  const SimpleColumn(String expression) : 
...
class QualifiedColumn extends Column {
  final String tableOrAlias;
  final String columnName;
  
  const QualifiedColumn(String expression, this.tableOrAlias, this.columnName) : super(expression);
...
class WildcardColumn extends Column {
  final String? tableOrAlias;
  
  WildcardColumn(String expression) : 
...
class AggregateColumn extends Column {
  const AggregateColumn(String expression) : super(expression);
...
class ExpressionColumn extends Column {
  const ExpressionColumn(String expression) : super(expression);
