...
void main() {
  group('ViewBuilder Tests', () {
    group('Unified API - New Approach', () {
      test('can create a simple view from table', () {
        final view = ViewBuilder.create('user_view').fromTable('users');
      ...
      test('can create a filtered view', () {
        final view = ViewBuilder.create('active_users')
      ...
      test('can create view with specific columns', () {
        final view = ViewBuilder.create('user_summary')
      ...
      test('can create view with expressions and aliases', () {
        ...
        final view = ViewBuilder.create('user_enhanced')
            .fromTable('users', expressions: expressions);
      ...
      test('can create view with complex query', () {
        final view = ViewBuilder.create('complex_view').fromQuery((query) =>
          query
            .select([
    ...
    group('Backward Compatibility - Legacy API', () {
      test('legacy simple() method still works', () {
      ...
      test('legacy withColumns() method still works', () {
      ...
      test('legacy fromSql() method still works', () {
